...
def post_list_view(request,tag_slug=None):
    ...
    paginator = Paginator(post_list, 4)  # no.of.pages(20/2-rec=>10-pages)
...
#send_mail('Hello', 'Very imp msg....','gayitrisree@gmail.com',['gayitrisree@gmail.com','meghananeeli753@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'gayitrisree@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
	    form=EmailSendForm()
